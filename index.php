...
<html lang="en">
    ...
    <body>
            ...
            <div class="wrapper">
                ...
                <div class="menu">
                    <ul>
                        ...
                        <li><a href="fasilitas_kesehatan.php">Fasilitas kesehatan</a></li>
        ...
        <div class="wrapper">
            ...
            <section id="home">
                ...
                <div class="kolom_home">
                    ...
                    <p class="informasi">
                        Website kami menyediakan informasi terkait distribusi fasilitas kesehatan, seperti rumah sakit, puskesmas, apotek, secara informatif. Anda dapat mengetahui fasilitas-fasilitas kesehatan yang tersedia di beberapa
                        tempat di kota Mataram.
                    </p>
                    <p><a href="fasilitas_kesehatan.php" class="tbl-pink">Pelajari Lebih Lanjut</a></p>
                </div>
            </section>
            ...
            <section id="courses">
                <div class="kolom">
                    ...
                    <p>
                        Dengan HEALS, Anda dapat dengan mudah menemukan fasilitas kesehatan terdekat di Kota Mataram. Kami menyediakan informasi lengkap dan akurat tentang rumah sakit, puskesmas, dan klinik untuk memenuhi kebutuhan
                        kesehatan Anda. Jangan khawatir mencari fasilitas kesehatan, karena kami siap membantu Anda menemukan yang terbaik.
                    </p>
            ...
            <section id="tutors">
                <div class="tengah">
                    <div class="kolom">
                        ...
                        <h2>Our Team</h2>
                        <p>
                            Tim kami berdedikasi tinggi dalam memberikan informasi mengenai fasilitas kesehatan terdekat. Dengan pengalaman yang dimiliki, kami siap memberikan informasi dan layanan terbaik untuk membantu Anda menemukan
                            fasilitas kesehatan terdekat yang sesuai dengan kebutuhan Anda. Kami percaya bahwa kesehatan adalah aset berharga, dan kami berkomitmen untuk mendukung Anda dalam menjaga kesehatan dengan menyediakan informasi
            ...
            <section id="partners">
                <div class="tengah">
                    <div class="kolom">
                        ...
                        <h2>Partners</h2>
                        <p>
                            Kami bekerja sama dengan berbagai mitra terpercaya yang berkomitmen untuk memberikan pelayanan kesehatan terbaik, yang terdiri dari rumah sakit, puskesmas, dan klinik sekitar kota Mataram. Kami bergerak dibawah
                            Universitas Mataram dan Prodi Teknik Informatika.
                        </p>
                    </div>
        ...
        <div id="copyright">
            <div class="wrapper_aboutus">&copy; 2024. <b>HEALS.</b> Pemrograman web</div>
        </div>
    </body>
</html>
